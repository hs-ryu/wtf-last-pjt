        ...
        <div class="card-body p-0" >
          <div class="hover_effect_box hover_effect_1">
            <div class="content_bg" >
              <img :src="'http://image.tmdb.org/t/p/w200/' + searchMovie.poster_path" style="width: 167px;  height: 250px; object-fit: cover;  z-index: 0;" class="card-img-top rounded d-block" alt="">
            </div>
            <div class="caption">
              <p class="caption_title">
                {{ searchMovie.title }}
              </p>
              <br v-if="searchMovie.title.length <= 10">
              <div class="caption_desc">
                <p></p>
                <br>
                평점 : {{ searchMovie.rank_average ? searchMovie.rank_average.toFixed(1)  + '★': '-' }}<br>
                개봉일<br>
                {{ searchMovie.release_date }}<br>
                <br>
              </div>
            </div>
          </div>
